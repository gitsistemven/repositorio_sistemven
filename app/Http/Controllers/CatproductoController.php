...
class CatproductoController extends Controller
{
    function _construct()
    {
        $this->middleware('permission:ver-catproducto|crear-catproducto|editar-catproducto|borrar-catproducto',['only'=>['index']]);
        $this->middleware('permission:crear-catproducto',['only'=>['create','store']]);
        $this->middleware('permission:editar-catproducto',['only'=>['edit','update']]);
        $this->middleware('permission:borrar-catproducto',['only'=>['destroy']]);
    }
    /**
